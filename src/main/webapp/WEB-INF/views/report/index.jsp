						...
						<li>
							<div class="item-content" >
								...
								<div class=" col-xs-6 col-sm-6">
									<p class="item_title">一类发票</p>
						        	<h4>查看一类发票</h4>
					        	</div>
					        	<div class="col-xs-4 col-sm-4">
					        		<a href="${ctx}/report/report1 ">
					...
					<ul>
						<li >
							<div class="item-content" >
					        	...
					        	<div class="col-xs-4 col-sm-4">
					        		<a href="http://10.128.137.245:18080/smartbi/vision/openresource.jsp?resid=I8a000d370156c0a7c0a7a22d0156d4e1dae569d9&user=haolj&password=123456">
					        			<i class="fa fa-angle-right fa-size"></i>
					        		</a>
					        	</div>
							</div>
