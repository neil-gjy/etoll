package com.tjport.common.utils.wechat;

import com.alibaba.fastjson.JSONObject;
import com.tjport.common.utils.menu.Button;
import com.tjport.common.utils.menu.ClickButton;
import com.tjport.common.utils.menu.Menu;
...
public class MaterialUtils {
	...
	public static int getMaterialList(String token, String type, String offset, String count){
		...
		JSONObject jsonObject = weChatUtil.postStr(url, postStr);
